...
bool binarno_stablo::remove_children(const POSITION pos) {

	if (pos->left_child != nullptr)
	{
		remove_children(pos->left_child);
		delete pos->left_child;
		pos->left_child = nullptr;
	}
	if (pos->right_child != nullptr)
	{
		remove_children(pos->right_child);
		delete pos->right_child;
		pos->right_child = nullptr;
	}
	return true;
}
