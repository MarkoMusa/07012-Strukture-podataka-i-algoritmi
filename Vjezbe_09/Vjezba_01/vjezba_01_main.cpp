/*
	Učitajte prvih 20.000 slučajnih brojeva iz datoteke
	puno_brojeva1.txt u program. Primijenite sve algoritme
	sortiranja iz priloga na brojeve iz datoteke i ispišite za
	svaki koliko je trajao.  
*/
